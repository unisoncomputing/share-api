module Share.Postgres.Causal.Conversions (namespaceStatsPgToV2) where

import Share.Postgres.Causal.Types qualified as PG
import Share.Postgres.Causal.Types qualified as PGCausal
