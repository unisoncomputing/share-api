module Share.BackgroundJobs.SerialisedEntitiesMigration.Worker (worker) where

import Ki.Unlifted qualified as Ki
import Share.BackgroundJobs.Monad (Background)
import Share.BackgroundJobs.SerialisedEntitiesMigration.Queries qualified as Q
