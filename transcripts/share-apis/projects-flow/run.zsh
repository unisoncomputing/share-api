...
fetch "$transcripts_user" GET project-readme "/users/transcripts/projects/app/readme"
fetch "$transcripts_user" GET project-browse-definition "/users/transcripts/projects/app/branches/main/definitions/by-name/someTerm"
fetch "$transcripts_user" GET project-browse-definition-in-dependency "/users/transcripts/projects/app/branches/main/definitions/by-name/lib.dep.depNum"
