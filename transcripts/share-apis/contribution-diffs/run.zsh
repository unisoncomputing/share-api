...
fetch "$transcripts_user" POST create-contribution-for-diff-kickoff '/users/transcripts/projects/contribution-diff/contributions' '{
...
# This should already be computed and shared by the above diff.
